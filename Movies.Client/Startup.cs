...
namespace Movies.Client
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<AuthentificationDelegatingHandler>();
            // MovieAPI client registration
            services.AddHttpClient("MovieAPIClient", options =>
            {
                options.BaseAddress = new System.Uri("https://localhost:5005");
                options.DefaultRequestHeaders.Clear();
                options.DefaultRequestHeaders.Add(HeaderNames.Accept, "application/json");
            }).AddHttpMessageHandler<AuthentificationDelegatingHandler>();
